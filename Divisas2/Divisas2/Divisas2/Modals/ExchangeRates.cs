...
namespace Divisas2.Modals
{
    public class ExchangeRates
    {
        //For to Map a object and convert to list
        //this work thanks a Nuget
        ...
        //public NameExchangeRates NameExchangeRates { get; set; }
    ...
    public class Rate
    {
        ...
        public string NameTaxRate { get; set; }
    }
    ...
    public class NameExchangeRates
    {
       // public NameExchangeRates nameExchangeRates { get; set; }
